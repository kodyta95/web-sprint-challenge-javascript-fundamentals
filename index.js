...
//the nested function can access the variable internal because it is setup as a scope with a closure to be able to work.
  ...
  */
  ...
  function animalNames(arr){
    ...
    arr.forEach(function(item){
      filteredAnimals.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    });
